...
{
    /// <inheritdoc />
    public partial class InitialIMS : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OutstandingCredit = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Customers_AppUsers_RegisteredByStaffId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PurchaseInvoices_AppUsers_CreatedByAdminId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VehicleParts_Vendors_PrimaryVendorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_CustomerReview_Rating", "\"Rating\" >= 1 AND \"Rating\" <= 5");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    CustomerId = table.Column<Guid>(type: "uuid", nullable: false),
                    RequestedPartName = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    RequestedPartNumber = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SalesInvoices_AppUsers_ProcessedByStaffId",
            ...
            migrationBuilder.CreateTable(
                name: "FailurePredictionAlerts",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    CustomerId = table.Column<Guid>(type: "uuid", nullable: false),
                    VehicleId = table.Column<Guid>(type: "uuid", nullable: false),
                    VehiclePartId = table.Column<Guid>(type: "uuid", nullable: true),
                    PredictionSummary = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FailurePredictionAlerts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FailurePredictionAlerts_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FailurePredictionAlerts_VehicleParts_VehiclePartId",
                        column: x => x.VehiclePartId,
                        principalTable: "VehicleParts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_FailurePredictionAlerts_Vehicles_VehicleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FailurePredictionAlerts_CustomerId",
                table: "FailurePredictionAlerts",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_FailurePredictionAlerts_IsResolved",
                table: "FailurePredictionAlerts",
                column: "IsResolved");

            migrationBuilder.CreateIndex(
                name: "IX_FailurePredictionAlerts_VehicleId",
                table: "FailurePredictionAlerts",
                column: "VehicleId");

            migrationBuilder.CreateIndex(
                name: "IX_FailurePredictionAlerts_VehiclePartId",
                table: "FailurePredictionAlerts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesInvoices_ProcessedByStaffId",
                table: "SalesInvoices",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VehicleParts_PartNumber",
                table: "VehicleParts",
                column: "PartNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_VehicleParts_PrimaryVendorId",
                table: "VehicleParts",
                column: "PrimaryVendorId");

            migrationBuilder.CreateIndex(
                name: "IX_VehicleParts_StockQuantity",
                table: "VehicleParts",
